...
namespace ConsoleApp6
{
    public class AesBcCrypto
    {
        ...
        public AesBcCrypto(CipherMode cipherMode = CipherMode.CTS, PaddingMode padding =PaddingMode.None)
        {
        ...
        private ICipherParameters CreateKeyParameters(byte[] key, byte[] iv, int macSize)
        {
            ...
            else if (_cipherMode == CipherMode.CTS)
            {
